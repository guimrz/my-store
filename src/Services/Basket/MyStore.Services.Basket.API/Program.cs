...
try
{
    ...
    // Configure mapping
    builder.Services.AddAutoMapper(config => config.AddMaps(Assembly.Load("MyStore.Services.Basket.Application")));

    // Configure MediatR
    builder.Services.AddMediatR(Assembly.Load("MyStore.Services.Basket.Application"));

    // Configure request validation
    builder.Services.AddRequestValidation(Assembly.Load("MyStore.Services.Basket.Application"));
